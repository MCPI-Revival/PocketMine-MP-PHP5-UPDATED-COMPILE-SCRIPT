...
wget https://github.com/php/php-src/archive/refs/tags/php-$PHP_VERSION.tar.gz -q -O - | tar -zx >> "$DIR/install.log" 2>&1
mv php-src-php-$PHP_VERSION php
echo " done!"

#zlib
echo -n "[zlib] downloading $ZLIB_VERSION..."
wget https://github.com/madler/zlib/archive/refs/tags/v$ZLIB_VERSION.tar.gz -q -O - | tar -zx >> "$DIR/install.log" 2>&1
...
wget https://ftp.gnu.org/gnu/gmp/gmp-$GMP_VERSION.tar.bz2 -q -O - | tar -xj >> "$DIR/install.log" 2>&1
